            ...
            <div className="row g-4">
              <div className="col-xxl-9 col-xl-8 col-lg-7 order-lg-2">
                <div className="row g-4">
                  ...
                  <div className="col-12">
                    <div className="blog-box blog-list wow fadeInUp" data-wow-delay="0.05s">
                      <div className="blog-image">
                  ...
                  <div className="col-12">
                    <div className="blog-box blog-list wow fadeInUp" data-wow-delay="0.1s">
                      <div className="blog-image">
                        <a href="blog-detail.html">
                  ...
                  <div className="col-12">
                    <div className="blog-box blog-list wow fadeInUp" data-wow-delay="0.15s">
                  ...
                  <div className="col-12">
                    <div className="blog-box blog-list wow fadeInUp" data-wow-delay="0.2s">
                      <a href="blog-detail.html" className="blog-image">
                  ...
                  <div className="col-12">
                    <div className="blog-box blog-list wow fadeInUp" data-wow-delay="0.25s">
                      <a href="blog-detail.html" className="blog-image">
                        <img src={blog1} className=" lazyload" alt />
                      </a>
                      <div className="blog-contain blog-contain-2">
                  ...
                  <div className="col-12">
                    <div className="blog-box blog-list wow fadeInUp" data-wow-delay="0.3s">
                      <a href="blog-detail.html" className="blog-image">
                        <img src={blog2} className=" lazyload" alt />
                      </a>
                      <div className="blog-contain blog-contain-2">
                  ...
                  <div className="col-12">
                    <div className="blog-box blog-list wow fadeInUp" data-wow-delay="0.35s">
                      <a href="blog-detail.html" className="blog-image">
                  ...
                  <div className="col-12">
                    <div className="blog-box blog-list wow fadeInUp" data-wow-delay="0.4s">
                      <a href="blog-detail.html" className="blog-image">
